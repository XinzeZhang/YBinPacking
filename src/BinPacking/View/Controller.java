...
//    }
    ...
    private void boxTableInit(){
        ...
        addLength.prefWidthProperty().bind(addWrap.widthProperty().multiply(0.16));
        addWidth.prefWidthProperty().bind(addWrap.widthProperty().multiply(0.16));
        addHeight.prefWidthProperty().bind(addWrap.widthProperty().multiply(0.16));
        addNum.prefWidthProperty().bind(addWrap.widthProperty().multiply(0.16));
        addBox.prefWidthProperty().bind(addWrap.widthProperty().multiply(0.16));
        ...
        addNum.setTextFormatter(getDigitValidator());

        //Add box listener
        addBox.setOnAction(e -> {
        	int boxnum=Integer.parseInt(addNum.getText());
