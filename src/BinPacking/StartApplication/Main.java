...
public class Main extends Application{
    ...
    public void start(Stage primaryStage) throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/BinPacking/View/ui_addNum.fxml"));
    ...
    private Scene createScene(GridPane root){
        final double MAIN_SCREEN_W_SCALE = 0.75;
        final double MAIN_SCREEN_H_SCALE = 0.75;
